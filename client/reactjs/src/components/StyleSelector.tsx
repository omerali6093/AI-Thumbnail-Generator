...
const StyleSelector = ({ value, onChange, isOpen, setIsOpen } :
    {
        ...
        const styleDescriptions : Record<ThumbnailStyle, string> = {
            ...
            "Illustrated" : "Hand-draw, artistic, creative",
    ...
    return (
        <div className="space-y-3 relative dark">
            ...
            px-4 py-3 text-left transition bg-white/8 border-white/10 text-zinc-200
            hover:bg-white/12">
            ...
            {isOpen && (
                <div className="absolute bottom-0 z-50 mt-1 w-full rounded-md
                border border-white/12 bg-black/20 backdrop-blur-3xl shadow-lg">
